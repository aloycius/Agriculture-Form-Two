# Agriculture Form Two — ADT Bundle Reference
...
├── agriculture-form-two.db                    # SQLite database (pipeline state)
├── agriculture-form-two.pdf                   # Original source PDF
...
```json
{
  ...
  "pg001_im001": "",
  "gl001": "abattoir",
  "gl001_def": "a slaughterhouse; a place where animals are killed and prepared for meat",
  "qz001_que": "What is the first step in crop production mentioned in the text?",
  "qz001_o0": "1) Planning",
  "qz001_o0_exp": "✅ Correct! The text says planning is the foremost mental activity in crop production."
}
```
...
```json
{
  "abattoir": {
    "word": "abattoir",
    "definition": "a slaughterhouse; a place where animals are killed and prepared for meat",
    "variations": ["abattoirs"],
    "emoji": "🏭🥩"
  }
}
```
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">What is the first step in crop production mentioned in the text?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="✅ Correct! The text says planning is the foremost mental activity in crop production." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) Planning</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `agriculture-form-two.pdf` |
| Pipeline database | `agriculture-form-two.db` (SQLite) |
